...
public class SmackAB implements MessageListener{
	...
	public static void main(String[] args) throws XMPPException, IOException{
		...
		EXIXMPPAlternativeConnection connection = new EXIXMPPAlternativeConnection(config);
		connection.connect();
	...
	public static void encodingDecodingTest() throws IOException{
		...
		try {
			...
			EXIProcessor ep = new EXIProcessor(EXIUtils.canonicalSchemaLocation, new EXISetupConfiguration());
