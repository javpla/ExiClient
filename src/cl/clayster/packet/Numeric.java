...
public class Numeric implements PacketExtension {
	...
	public String toXML() {
        ...
        if(historicalHour != null) buf.append("\" historicalHour=\"").append(getHistoricalHour());
        if(historicalDay != null) buf.append("\" historicalDay=\"").append(getHistoricalDay());
        if(status != null) buf.append("\" status=\"").append(getStatus());
        if(momentary != null) buf.append("\" momentary=\"").append(getMomentary());
        ...
        if(unit != null) buf.append("\" unit=\"").append(getUnit());
        buf.append("\"/>");
        return buf.toString();
	}
